...
- Individual modules (Headers, SSL, Paths, JavaScript Analysis, CORS Testing)
...
Options:
  ...
  -p, --profile     Scan profile: quick, standard, comprehensive, deep, passive, stealth, api, cms
...
Options:
  -o, --output      Output file (supports .json, .html, .pdf)
  -t, --threads     Concurrent scans (default: 5, lower for thorough testing)
  -q, --quiet       Minimal output
```
